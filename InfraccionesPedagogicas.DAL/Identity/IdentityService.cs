...
namespace InfraccionesPedagogicas.Infrastructure.Services

{
    public class IdentityService : IIdentityService
    {
        ...
        public IdentityService(UserManager<Usuario> userManager, SignInManager<Usuario> signInManager, RoleManager<IdentityRole> roleManager)
        {
        ...
        public async Task<(string userId, string fullName, string UserName, string email, IList<string> roles)> GetUserDetailsAsync(string userId)
        {
            ...
            return (user.Id, user.Nombre, user.UserName, user.Email, roles);
        }
