...
namespace InfraccionesPedagogicas.Application.Interfaces.Services
{
    public  interface IIdentityService
    {
        ...
        Task<List<(string id, string userName, string email, string role)>> GetAllUsersDetailsExceptLoggedUserAsync(IPaginationFilter pagination, string userId);
        Task<int> GetCountForAllUsersDetailsExceptLoggedUserAsync(string userId);
